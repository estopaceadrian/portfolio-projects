...
export const PortfolioSection = ({
  ...
  return (
    <section>
      <header
        className="flex justify-between pt-10 pr-10 lg:pt-20 lg:pr-20 "
      ...
      <div className=" grid grid-cols-7 gap-8  bg-zinc-800 p-10 lg:p-20">
        <div className="col-span-7 flex max-w-xl flex-col lg:col-span-3">
          ...
          <p className="text-sm text-zinc-400">{descriptions} </p>
        </div>
        ...
        <div className="col-span-7 flex max-w-xl flex-col lg:col-span-2">
          ...
          <ul className="list-none space-y-1 ">
            {links.map((link) => (
              <li key={link.text} className="text-sm" style={{ color: color }}>
                <a
                  href={link.href}
